...
.. multiliteralinclude:: src/mtc_node.cpp
   :language: c++
   :linenos:
   :sections-exclusive: ["// Code starts here","// Disable warnings for this line"],["#pragma GCC diagnostic ignored", "#pragma GCC diagnostic pop"],["#pragma GCC diagnostic pop","auto stage_move_to_pick = std::make_unique<mtc::stages::Connect>"],["// Stages all added to the task above this line","EOF"]
...
.. literalinclude:: src/mtc_node.cpp
   :language: c++
   :linenos:
   :start-at:  #include <rclcpp/rclcpp.hpp>
   :lines: -17
...
.. literalinclude:: src/mtc_node.cpp
   :language: c++
   :lineno-start: 18
   :start-at:  static const rclcpp::Logger LOGGER = rclcpp::get_logger
   :lines: -3
...
.. literalinclude:: src/mtc_node.cpp
   :language: c++
   :lineno-start: 39
   :start-at:  rclcpp::node_interfaces::NodeBaseInterface::SharedPtr
   :lines: -6
...
.. literalinclude:: src/mtc_node.cpp
   :language: c++
   :lineno-start: 45
   :start-at:  MTCTaskNode::MTCTaskNode(const rclcpp::NodeOptions& options)
   :lines: -5
...
.. literalinclude:: src/mtc_node.cpp
   :language: c++
   :lineno-start: 50
   :start-at:  void MTCTaskNode::setupPlanningScene()
   :lines: -18
...
.. literalinclude:: src/mtc_node.cpp
   :language: c++
   :lineno-start: 68
   :start-at: void MTCTaskNode::doTask()
   :lines: -30
...
.. literalinclude:: src/mtc_node.cpp
   :language: c++
   :lineno-start: 99
   :start-at: mtc::Task MTCTaskNode::createTask()
   :lines: -14
...
.. literalinclude:: src/mtc_node.cpp
   :language: c++
   :lineno-start: 114
   :start-at:  mtc::Stage* current_state_ptr 
   :lines: -2,5-7
...
.. literalinclude:: src/mtc_node.cpp
   :language: c++
   :lineno-start: 125
   :start-at: auto cartesian_planner = std::make_shared<mtc::solvers::CartesianPath>();
   :lines: -4
...
.. literalinclude:: src/mtc_node.cpp
   :language: c++
   :lineno-start: 141
   :start-at: auto stage_move_to_pick = std::make_unique<mtc::stages::Connect>
   :lines: -6
...
.. literalinclude:: src/mtc_node.cpp
   :language: c++
   :lineno-start: 148
   :start-at: mtc::Stage* attach_object_stage
   :lines: -2
...
.. literalinclude:: src/mtc_node.cpp
   :language: c++
   :lineno-start: 153
   :start-after: // In fact, `task` itself is a SerialContainer by default.
   :lines: -5
...
.. literalinclude:: src/mtc_node.cpp
   :language: c++
   :lineno-start: 188
   :start-at: // This is the transform from the object frame to the end-effector frame
   :lines: -7
...
.. literalinclude:: src/mtc_node.cpp
   :language: c++
   :lineno-start: 224
   :start-at:   // Attach the object
   :lines: -7

Next, we lift the object with a ``MoveRelative`` stage, similarly to the ``approach_object`` stage and set the direction upward.

.. literalinclude:: src/mtc_node.cpp
   :language: c++
   :lineno-start: 231
   :start-at:   // Lift the object
   :lines: -16
...
.. literalinclude:: src/mtc_node.cpp
   :language: c++
   :lineno-start: 247
   :start-at: task.add(std::move(grasp));
   :lines: -2
...
.. literalinclude:: src/mtc_node.cpp
   :language: c++
   :lineno-start: 249
   :start-at: // Move to place the object
   :lines: -10
...
.. literalinclude:: src/mtc_node.cpp
   :language: c++
   :lineno-start: 259
   :start-at: // Create serial container
   :lines: -6
...
.. literalinclude:: src/mtc_node.cpp
   :language: c++
   :lineno-start: 310
   :start-at: // Detach from the object
   :lines: -6
...
.. literalinclude:: src/mtc_node.cpp
   :language: c++
   :lineno-start: 341
   :start-at: // Stages all added to the task above this line
   :lines: -4
